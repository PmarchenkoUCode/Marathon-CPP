...
static void meadFirstPrint(int32_t i) {
...
static void meadSecondPrint(int32_t i, int32_t count) {
    ...
    i == 1 ? std::cout << i << " bottles" : std::cout << i << " bottles";
